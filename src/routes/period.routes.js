...
// Crea movimiento libre; si no existe periodo para movementDate lo crea (autoCreatePeriod=true por defecto)
router.post('/movements', movementCtrl.createMovement);
